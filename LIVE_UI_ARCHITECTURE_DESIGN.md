...
**Важно:** Live UI v2 является **единственным пользовательским интерфейсом** проекта teltel. Legacy UI (web/) удалён. Все функции доступны в Live UI v2 на http://localhost:3000. Подробнее о миграции см. [docs/UI_MIGRATION.md](docs/UI_MIGRATION.md).
