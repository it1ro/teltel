...
### Этап 8.5: UI компоненты для управления run'ами 🚧 В ПРОЦЕССЕ

- [ ] **RunSelector компонент** - выбор run'ов для сравнения
- [ ] **RunList компонент** - отображение списка доступных run'ов
- [ ] Интеграция в LeftPanelRegion или HeaderRegion

### Этап 8.6: Визуализация сравнения run'ов 🚧 В ПРОЦЕССЕ
...
### Этап 8.7: Интеграция в существующие графики 🚧 В ПРОЦЕССЕ
